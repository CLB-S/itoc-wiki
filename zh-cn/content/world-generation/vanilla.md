...
目前，ITOC 原版世界的默认预生成尺寸为 100km x 100km。

![100km x 100km](/content/world-generation/vanilla/vanilla-world-size.png)

整个预生成时间少于 4 秒。(i5-12500h)

![](/content/world-generation/vanilla/vanilla-world-gen-0.png)

关于真实河流与山脉生成，参见 [G. Cordonnier et al., "Large Scale Terrain Generation from Tectonic Uplift and Fluvial Erosion"](https://onlinelibrary.wiley.com/doi/10.1111/cgf.12820)。

Uplift map 目前由板块构造生成：

![](/content/world-generation/vanilla/vanilla-world-gen-1.png)

Uplift map 用于控制河流生成和高度图生成：

![](/content/world-generation/vanilla/vanilla-world-gen-2.png)

基于噪声（[纹理树](./pattern-tree)）的降水和温度图：
